...
let totalEstudante = 0

if(estudante == "s" ) {
    totalEstudante = total - (10 * total / 100)
    alert (` O total foi de R$${totalEstudante}`)
} else {
    totalEstudante = total
    alert (` O total foi de R$${total}`)
}

let totalEstudanteDesconto = 0
    
if (totalEstudante >= 50 || total >= 50) {
    totalEstudanteDesconto = totalEstudante - (5 * totalEstudante / 100)
...
alert(`
    Obrigado ${nome}!
Pratos escolhidos:
- ${prato1} de R$ ${precoItem1}
- ${prato2} de R$ ${precoItem2}
- ${prato3} de R$ ${precoItem3}
Total sem desconto: R$ ${total}
Total com desconto: R$ ${totalEstudanteDesconto}
    `)